...
function TestOne() {
    ...
    function render_geometry(name: string) {
        return (
            <Col span={7} key={name}>
                <Card className='button_card' bordered={false} hoverable onClick={() => shuffle()} >
        ...
        <>
            ...
            <div>
                ...
                <Row justify={'end'} style={{paddingBottom: 16}}>
                    ...
                    <Button onClick={() => setTitle(" ")}>{t("main_page")}</Button>
                    </Col>
                </Row>
                {title === test.main && (
                    <div>
                        <Row gutter={24} justify='center' align="middle" className='item_center'>
                            <Col span={5}>
                                <Card title={t(Object.keys(test)[1])} bordered={false} onClick={() => setTitle(test.test_1)} hoverable>
                                    <p>{t(test.test_1)}</p>
                                </Card>
                            </Col>
                            <Col span={5}>
                            ...
                            <Col span={5}>
                                <Card title={t(Object.keys(test)[3])} bordered={false} onClick={() => setTitle(test.test_3)} hoverable>
                                    <p>{t(test.test_3)}</p>
                                </Card>
                            </Col>
                        </Row>
                    ...
                    <div key={"test_1"}>
                        <Row gutter={24} justify="center">
                            <Col span={5} className='center_justify'>
                                <Card className='button_card' bordered={false} hoverable onClick={() => left_shift()}>
                                    <div className='item_container'>
                            ...
                            <Col span={10} className='center_justify'>
                                <Card className='button_card' bordered={false} hoverable onClick={() => swap_layout()}>
                                    <div className='item_container'>
                            ...
                            <Col span={5} className='center_justify'>
                                <Card className='button_card' bordered={false} hoverable onClick={() => right_shift()}>
                                    <div className='item_container'>
                        ...
                        <Divider />
                        <Row gutter={24} justify={arrayLayout === 0 ? "end" : "start"} style={{ paddingBottom: 24 }}>
                            {geoArray.slice(0, 3).map((item: GEOMETRY) => (
                                render_geometry(GEOMETRY[item])
                            )
                            )}
                        </Row>
                        <Row gutter={24} justify={arrayLayout === 0 ? "start" : "end"}>
                            {geoArray.slice(3, 6).map((item: GEOMETRY) => (
                                render_geometry(GEOMETRY[item])
                            )
                            )}
                        </Row>
